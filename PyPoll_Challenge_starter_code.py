...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        Countyvote_percentage = float (votes) / float (total_votes) * 100


         # 6d: Print the county results to the terminal.
        county_results = (
             f"{county_name}:{Countyvote_percentage:.1f}%({votes:,})\n")
    ...
    for candidate_name in candidate_votes:
        ...
        # Determine winning vote count, winning percentage, and candidate. 1 2 3
